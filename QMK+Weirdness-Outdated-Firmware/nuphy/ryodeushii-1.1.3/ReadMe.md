## Ryodeushii Nuphy + SRGBP Firmware files ##

These firmware files are from the custom firmware source provided by [Ryodeushii](https://github.com/ryodeushii/qmk-firmware) + SignalRGB Protocol support added to them.
