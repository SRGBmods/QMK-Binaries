...
#### QMK Mainline ####
* **[0.23.8](https://github.com/SRGBmods/QMK-Binaries/tree/main/QMK%2BVIA-Firmware/0.23.8)** is the new [QMK Mainline github](https://github.com/qmk/qmk_firmware), currently being pulled and fixes to boards are applied and uploaded.
...
#### QMK Mainline ####
* **[0.23.9](https://github.com/SRGBmods/QMK-Binaries/tree/main/QMK%2BDefault-Firmware/0.23.9)** is from [QMK Mainline github](https://github.com/qmk/qmk_firmware), last default version to be compiled (This is default without VIA support - please note these exclude Keychron keyboards as the VIA & Keychron builds are vastly superior as far as features).
